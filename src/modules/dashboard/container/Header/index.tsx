          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav align-items-center  ml-md-auto ">
              ...
              <div className="media-body  d-none d-lg-block">
                { dashboardDetails && dashboardDetails.user_details &&<span className="mb-0 text-white  font-weight-bold">
                 ...
                 <div className="media align-items-center">
                    <span className="avatar avatar-sm rounded-circle">
                      <img
                        ...
                        src={ dashboardDetails && dashboardDetails.user_details.profile_photo ?  getImageUri(dashboardDetails.user_details.profile_photo): Icons.ProfilePlaceHolder}
                      />
                    </span>
