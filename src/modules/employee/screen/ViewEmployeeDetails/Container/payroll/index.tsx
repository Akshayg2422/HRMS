import { Card, CommonDropdownMenu, CommonTable, Container, DatePicker, FormTypography, FormWrapper, NoRecordFound, Primary, ScreenContainer } from '@components'
                    ...
                    <>
                        <Container additionClass='d-flex justify-content-between'>
                            ...
                            <CommonDropdownMenu
                                ...
                                onItemClick={(e, item) => {
                                    e.stopPropagation();
                                    goTo(navigation, ROUTE.ROUTE_PAYSLIP)
                                }}
                            />
                        </Container>
