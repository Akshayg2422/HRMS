...
export const NAV_ITEM = [
  ...
  {id: '2', name: 'Employee Portfolio', value: 'EP', icon: 'ni ni-ungroup', route: ROUTE.ROUTE_DASHBOARD_OTP},
  ...
  {id: '6', name: 'Employee Log', value: 'EL', icon: 'ni ni-single-copy-04', route: ROUTE.ROUTE_DASHBOARD_OTP},
